...
namespace ukf {
    ...
    public:
        ...
        void addNoise(const std::shared_ptr<Noise> &noise) { _noises.emplace_back(noise); }
    ...
    Eigen::MatrixXd SystemNoise::matrix() const {
    ...
    void MeasurementNoise::addNoise(const std::shared_ptr<const Sensor> &sensor) const {
